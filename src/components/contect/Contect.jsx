...
const Contect = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_93b6c41', 'template_g7ggsmo', formRef.current, {
        publicKey: 'fyjyXQx7_71170iW8',
      })
      .then(
        () => {
            setSuccess(true)
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>vijaysinghsisodiya966@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
          <span>Ugran,district Neemuch (M.P)</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Phone</h2>
          <span>+91 8839384160</span>
        </motion.div>
      </motion.div>
